	...
	where TIntegrationEvent : class, IEvent
{
	...
	{
		_logger.LogInformation("Handling '{RowChangedEventTypeName}' for source changed event '{SourceEventTypeName}'", nameof(RowDeletedEvent<TSourceEvent>), typeof(TSourceEvent).Name);
